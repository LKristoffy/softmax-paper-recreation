...
def dot_product_attention_weights(query: Array,
                                  ...
                                  softmax_fnc: Callable[[Array], Array] = jax.nn.softmax) -> Array:
  ...
  attn_weights = softmax_fnc(attn_weights).astype(dtype)
...
def dot_product_attention_with_adaptive_temp(query: Array,
                          key: Array,
                          value: Array,
                          bias: Optional[Array] = None,
                          mask: Optional[Array] = None,
  ...
  attn_weights = dot_product_attention_weights(
      ...
      deterministic, dtype, precision, softmax_fnc=softmax_fnc)
...
class MultiHeadDotProductAttention(Module):
  ...
  use_bias: bool = True
  attention_fn: Callable[[Array, Array, Array], Array] = dot_product_attention_with_adaptive_temp
  softmax_fnc: Callable[[Array], Array] = jax.nn.softmax
  decode: bool = False
